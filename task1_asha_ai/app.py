...
env_path_parent = os.path.join(os.path.dirname(os.path.abspath(__file__)), "..", ".env")
env_path_current = os.path.join(os.path.dirname(os.path.abspath(__file__)), ".env")
...
if not os.getenv("GROQ_API_KEY"):
    ...
    st.error(f"Checked: {env_path_parent} and {env_path_current}")
    st.stop()
...
def save_lead(data):
    ...
    # Shared Data Bridge
    csv_file = os.path.join(os.path.dirname(os.path.abspath(__file__)), "..", "leads.csv")
